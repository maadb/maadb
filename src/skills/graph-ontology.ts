// ============================================================================
// Graph / Ontology skill — managed instruction generator (fully static).
// ============================================================================

export function generateGraphOntologySkill(): string {
  return `# Working the Project as a Typed Graph

> Managed by the MAADb engine — do not edit (changes block future refreshes).
> Project-specific ontology conventions belong in \`_skills/local/ontology.md\`.
> Findings and densification notes go there too — never append them to this file.
...
- **No visualization here.** Emitting a small inline Mermaid/DOT sketch in
  ...
  host-side skills — never to \`@maadb/core\`.
